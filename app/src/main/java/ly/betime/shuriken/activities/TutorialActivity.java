...
public class TutorialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!getSharedPreferences(Preferences.NAME, Context.MODE_PRIVATE)
                .getBoolean(Preferences.FIRST_START, Preferences.FIRST_START_DEFAULT_VALUE)) {
            launchHomeScreen();
            finish();
        } else {
            SharedPreferences.Editor editor = getSharedPreferences(Preferences.NAME, Context.MODE_PRIVATE).edit();
            editor.putBoolean(Preferences.FIRST_START, false);
            editor.apply();
        }
